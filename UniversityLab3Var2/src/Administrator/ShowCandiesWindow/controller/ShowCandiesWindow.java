package Administrator.ShowCandiesWindow.controller;
...
public class ShowCandiesWindow {
    ...
    @FXML
    private Button sortCandiesBySugarBtn;
    ...
    @FXML
    private Button sortCandiesByWeightBtn;
    ...
    public int containersUpdater() {
        ...
        for (Candy candy: controller.getCandies()) {
            ...
            Label label2 = new Label(Integer.toString(candy.getSugarNum()));
            ...
            Label label3 = new Label(Integer.toString(candy.getCandyWeight()));
    ...
    void initialize() {
        if (containersUpdater() == 0){
            ...
            statusLineLabel.setText("Список конфет пуст!");
        }


        sortCandiesBySugarBtn.setOnAction(event -> {
            controller.sortCandiesBySugar();
        ...
        sortCandiesByWeightBtn.setOnAction(event -> {
